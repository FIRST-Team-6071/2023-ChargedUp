...
public class ArmSubsystem extends SubsystemBase {
  ...
  PIDController tiltPID = new PIDController(8, 2, 0);
  ...
  public void periodic() {
    ...
    if (hasExtensionZeroed) {
      m_TiltMotor.set(VictorSPXControlMode.PercentOutput, -MathUtil.clamp(pidOutput, -0.5, 0.5));
    }
